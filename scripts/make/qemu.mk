...
qemu_args-riscv64 := \
  ...
  -kernel $(OUT_BIN) \
  -drive if=pflash,file=/root/work/arceos_lkmodel/payload/apps.bin,format=raw,unit=1
  # -bios /root/work/opensbi/build/platform/generic/firmware/fw_jump.bin   /root/work/fw_jump1.4.bin 
