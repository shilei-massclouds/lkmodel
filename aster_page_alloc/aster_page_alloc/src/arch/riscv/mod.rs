...
use crate::{
    ...
    boot::memory_region::{non_overlapping_regions_from, MemoryRegion, MemoryRegionType},
    boot::{BootloaderAcpiArg, BootloaderFramebufferArg},
};

use aster_boot::early_println;
use aster_boot::kspace::paddr_to_vaddr;
...
pub fn arch_init(_hart_id: usize, device_tree_paddr: usize) {
